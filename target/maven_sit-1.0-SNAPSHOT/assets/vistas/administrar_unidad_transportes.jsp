...
<body>
  ...
  <main class="d-flex flex-column justify-content-center align-items-center">
    ...
    <div class="mb-3">
      <h3>ADMINISTRACION DE UNIDADES DE TRANSPORTES</h3>
    </div>
    ...
    <section id="tabla">
      <table class="" id="miTabla" style="width:100%;">
        ...
        <tbody>
            ...
            List<UnidadTransporteDTO> lista = dao.listarCompletoUnidadTransportistas();
            Iterator<UnidadTransporteDTO> iter = lista.iterator();
            UnidadTransporteDTO uni = null;
            while(iter.hasNext()){
                uni = iter.next();
          %>
          <tr>
            <td style="background-color:#1e1e20;"><%= uni.getId()%></td>
            <td style="background-color:#1e1e20;"><%= uni.getPlaca()%></td>
            <td style="background-color:#1e1e20;"><%= uni.getMarca()%></td>
            <td style="background-color:#1e1e20;"><%= uni.getModelo()%></td>
    ...
    <section class="my-4 d-flex">
      ...
      <script>
        ...
        boton.addEventListener('click', function() {
            ...
            window.location.href = 'registroUnidadTransporte.jsp';
        });
        // Agregar un controlador de eventos de clic al botï¿½n
