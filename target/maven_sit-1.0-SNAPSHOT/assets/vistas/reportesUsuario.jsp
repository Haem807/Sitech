...
<head>
  ...
  %>
  <title>Reporte de Usuario: <%= nombre%></title>
  <!--CSS-->
        ...
        <table class="" id="miTabla" style="width:100%;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="background-color:#1e1e20;"><%= usu.getFecha_registro()%></td>
                <td style="background-color:#1e1e20;"><%= usu.getHora_registro()%></td>
                <td style="background-color:#1e1e20;"><%= usu.getNombre_transportista()%></td>
                <td style="background-color:#1e1e20;"><%= usu.getTarjeta()%></td>
