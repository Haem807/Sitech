...
<head>
  ...
  <%
              ...
              List<ViajeDTO> viajeDTO = (List<ViajeDTO>) request.getAttribute("viajesReportesPagos");
  ...
  %>
  <title>Reporte de Transportista: <%= nombre%></title>
  <!--CSS-->
...
<body>
  ...
  <main class="d-flex flex-column justify-content-center align-items-center">
    ...
    <div class="mb-3">
      <h3>REPORTE DE TRANSPORTISTA: <%= nombre%></h3>
    </div>
